            ...
            return (
              ...
              >
                <Link href={`/services/${service.slug}`} className="block h-full">
                  <div className="relative group bg-gray-50 rounded-2xl p-8 md:p-10 h-full border border-gray-100 hover:border-brand-gold/30 hover:bg-white hover:shadow-2xl hover:shadow-brand-gold/5 transition-all duration-500 hover:-translate-y-1 overflow-hidden">
                    {/* Background number */}
                    <div className="absolute top-6 right-8 font-heading font-extrabold text-[80px] leading-none text-gray-100 group-hover:text-brand-gold/10 transition-colors duration-500 select-none">
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-xl md:text-2xl font-bold font-heading text-brand-dark mb-3 group-hover:text-brand-gold transition-colors">
                        {service.name}
                      </h3>
